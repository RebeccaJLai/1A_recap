...
Defintely the one that people worry about the most. Let's do something that will definitely generate an error and have a look at it:

```{r error=TRUE}
demo <- read_csv("some_file_name.csv")
```
